...
class ElWindow(QMainWindow, form_class):
    ...
    def qMediaViewer(self, img):
        ...
        #qimage = qimage2ndarray.array2qimage(img)#, normalize=True)#False)

        #qimage = self.array_to_qimage(img, copy=False)
        if len(img.shape)<3:
        ...
        h, w, d = img.shape
        qimage = QImage(frame.data, w, h, d*w, QImage.Format_RGB888)
