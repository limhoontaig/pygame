...
btn_welfare_path = Button(welfare_frame, text="복지할인", width=10)#, command=add_file(kind='welfare'))
...
btn_kind_welfare_path = Button(kind_welfare_frame, text="할인종류", width=10)#, command=add_file(kind='kind'))
